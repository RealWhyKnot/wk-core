...
namespace WhyKnot.Core.Pipeline {

    public sealed class WkAvatarPreviewSession : IDisposable {

        private const string PrefsSourceGlobalId  = "WhyKnot.Core.PreviewSession.SourceGlobalId.";
        private const string PrefsSourceWasHidden = "WhyKnot.Core.PreviewSession.SourceWasHidden.";
